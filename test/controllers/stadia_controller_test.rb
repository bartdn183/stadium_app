...
class StadiaControllerTest < ActionController::TestCase
  ...
  test "should create stadium" do
    assert_difference('Stadium.count') do
      post :create, stadium: { name: @stadium.name, row: @stadium.row, seat: @stadium.seat, section: @stadium.section }
    end
  ...
  test "should update stadium" do
    patch :update, id: @stadium, stadium: { name: @stadium.name, row: @stadium.row, seat: @stadium.seat, section: @stadium.section }
    assert_redirected_to stadium_path(assigns(:stadium))
  end
